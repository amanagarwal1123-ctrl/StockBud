...
## Chunked Upload with Background Processing (Feb 11, 2026)
- Files >4MB auto-chunked into 4MB binary chunks
...
- Upload metadata persisted to disk (meta.json) — survives process restarts
...
## Backlog
- (P1) Upload queue — block concurrent uploads with user-facing message
